...
class RoundedRaffTheme : public BaseTheme {
 public:
  void drawHeader(const GfxRenderer& renderer, Rect rect, const char* title, const char* subtitle = nullptr,
                  bool readerContext = false, bool drawClock = true) const override;
  ...
  void drawButtonHintsSymbols(GfxRenderer& renderer, ButtonHintSymbol btn1, ButtonHintSymbol btn2,
                              ButtonHintSymbol btn3, ButtonHintSymbol btn4) const override;
