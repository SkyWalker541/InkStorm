...
const char* blockIntervalLabel(uint8_t index) {
  ...
  switch (index) {
    ...
    case 6: return "1 hour";
    case 7: return "3 hours";
    case 8: return "6 hours";
    case 9: return "12 hours";
...
const char* blockName(BlockId b) {
  switch (b) {
    case BLK_TEMP:   return "Temperature";
    case BLK_FEELS:  return "Feels like";
    case BLK_COND:   return "Conditions";
    case BLK_HUM:    return "Humidity";
    case BLK_WIND:   return "Wind";
    case BLK_UV:     return "UV / Solar";
    case BLK_AQI:    return "Air quality";
    case BLK_PRES:   return "Pressure";
    case BLK_SUN:    return "Sunrise/Sunset";
    case BLK_FC:     return "Forecast";
    case BLK_EXTRA:  return "More data";
...
const char* extraMetricName(uint8_t m) {
  switch (m) {
    case EXTRA_CLOUD:       return "Cloud cover";
    case EXTRA_VISIBILITY:  return "Visibility";
    case EXTRA_GUST:        return "Wind gust";
    case EXTRA_PRECIP:      return "Precipitation";
    case EXTRA_DEWPOINT:
    default:                return "Dew point";
  }
}

const char* weatherPowerActionName(uint8_t action) {
  switch (action) {
    case WX_POWER_CROSSINK: return "CrossInk";
    case WX_POWER_NONE:     return "Nothing";
...
static const char* kFullMonths[] = {"January", "February", "March", "April", "May", "June", "July",
...
void formatWeatherDate(char* buf, size_t n, uint8_t format, time_t now) {
  ...
  switch (format) {
    case 1: snprintf(buf, n, "%02d/%02d/%d", tm.tm_mday, mon, y); break;
    case 2: snprintf(buf, n, "%d-%02d-%02d", y, mon, tm.tm_mday); break;
    case 3: snprintf(buf, n, "%s %d, %d", kShortMonths[tm.tm_mon], tm.tm_mday, y); break;
    case 4: snprintf(buf, n, "%s %d, %d", kFullMonths[tm.tm_mon], tm.tm_mday, y); break;
    case 5: snprintf(buf, n, "%d %s %d", tm.tm_mday, kShortMonths[tm.tm_mon], y); break;
    case 6: snprintf(buf, n, "%d %s %d", tm.tm_mday, kFullMonths[tm.tm_mon], y); break;
    default: snprintf(buf, n, "%02d/%02d/%d", mon, tm.tm_mday, y); break;
  }
}

bool blockShown(BlockId b) {
  switch (b) {
    case BLK_TEMP:  return g_settings.showTemp;
    case BLK_FEELS: return g_settings.showFeelsLike;
    case BLK_COND:  return g_settings.showCondition;
    case BLK_HUM:   return g_settings.showHumidity;
    case BLK_WIND:  return g_settings.showWind;
    case BLK_UV:    return g_settings.showUv;
    case BLK_AQI:   return g_settings.showAirQuality;
    case BLK_PRES:  return g_settings.showPressure;
    case BLK_SUN:   return g_settings.showSun;
    case BLK_FC:    return g_settings.showForecast;
    case BLK_EXTRA: return g_settings.showExtra && g_settings.extData != EXTRA_OFF;
    default:        return true;
  }
}
...
uint8_t blockIntervalIndex(BlockId b) {
  switch (b) {
    case BLK_TEMP:  return g_settings.intTemp;
    case BLK_FEELS: return g_settings.intFeels;
    case BLK_COND:  return g_settings.intCond;
    case BLK_HUM:   return g_settings.intHum;
    case BLK_WIND:  return g_settings.intWind;
    case BLK_UV:    return g_settings.intUv;
    case BLK_AQI:   return g_settings.intAqi;
    case BLK_PRES:  return g_settings.intPres;
    case BLK_SUN:   return g_settings.intSun;
    case BLK_FC:    return g_settings.intFc;
    case BLK_EXTRA: return g_settings.intExtra;
    default:        return g_settings.intClock;
  }
}
...
void setBlockIntervalIndex(BlockId b, uint8_t index) {
  ...
  switch (b) {
    case BLK_TEMP:  g_settings.intTemp = index; break;
    case BLK_FEELS: g_settings.intFeels = index; break;
    case BLK_COND:  g_settings.intCond = index; break;
    case BLK_HUM:   g_settings.intHum = index; break;
    case BLK_WIND:  g_settings.intWind = index; break;
    case BLK_UV:    g_settings.intUv = index; break;
    case BLK_AQI:   g_settings.intAqi = index; break;
    case BLK_PRES:  g_settings.intPres = index; break;
    case BLK_SUN:   g_settings.intSun = index; break;
    case BLK_FC:    g_settings.intFc = index; break;
    case BLK_EXTRA: g_settings.intExtra = index; break;
    default:        g_settings.intClock = index; break;
  }
  settingsSave();
}

uint32_t blockIntervalSeconds(BlockId b) {
  return kIntervalSeconds[blockIntervalIndex(b)];
}

time_t blockLastFetch(BlockId b) {
  return s_lastFetch[b];
}
