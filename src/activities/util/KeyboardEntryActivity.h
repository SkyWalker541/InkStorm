...
class KeyboardEntryActivity : public Activity {
 public:
  explicit KeyboardEntryActivity(GfxRenderer& renderer, MappedInputManager& mappedInput,
                                 ...
                                 std::optional<GfxRenderer::Orientation> orientation = std::nullopt)
 ...
 private:
  ...
  // When set, render() forces this orientation for the whole frame so the
  // keyboard matches its parent activity (e.g. the weather app in landscape).
  std::optional<GfxRenderer::Orientation> forcedOrientation;
