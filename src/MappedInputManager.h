...
class MappedInputManager {
 public:
  ...
  struct Symbols {
    ButtonHintSymbol btn1;
    ButtonHintSymbol btn2;
    ButtonHintSymbol btn3;
    ButtonHintSymbol btn4;
  };
  ...
  // Same mapping as mapLabels but for symbol hints (used by the weather app).
  Symbols mapSymbols(ButtonHintSymbol back, ButtonHintSymbol confirm, ButtonHintSymbol previous,
                     ButtonHintSymbol next) const;
