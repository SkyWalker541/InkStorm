...
if (currentPath !== "/") {
  ...
  if (leaf) document.title = leaf + " - Files - CrossInk v1.5.0 / InkStorm v1.0.0 Dual Boot";
}
...
function exportLogToFile(filename = null, isBatch = false) {
  ...
  let logText = `CrossInk v1.5.0 / InkStorm v1.0.0 Dual Boot ${crosspointVersion} - EPUB Conversion Log\n`;
