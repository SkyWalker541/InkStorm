...
std::string getPanicInfo(bool full) {
  if (!full) {
    ...
    info += "CrossInk v1.5.0 / InkStorm v1.0.0 Dual Boot version: " CROSSINK_VERSION;
    info += "\nCrossInk v1.5.0 / InkStorm v1.0.0 Dual Boot device type: " CROSSINK_FIRMWARE_DEVICE_TYPE;
